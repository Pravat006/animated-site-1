...
function Hero() {
    ...
    const handleMiniVidClick = () => {
        setHasClicked(true)
        setCurrentIndex((previous) => (previous % totalVideos) + 1)
    }
    ...
    useGSAP(() => {
        ...
        gsap.from(videoFrameRef.current, {
            ...
            scrollTrigger: {
                ...
                start: "center center",
                end: "bottom center", // <-- fix typo here
                scrub: true
            }
        })
    })
    ...
    return (
        <div className='relative h-dvh w-screen overflow-x-hidden'>
            ...
            <div id='video-frame'
                ...
                <div>
                    <div className='mask-clip-path absolute-center absolute z-30 size-64 cursor-pointer overflow-hidden rounded-lg'>
                    ...
                    <video
                        ...
                        muted
                        id="next-video"
                        className='absolute-center size-64 invisible absolute z-20 object-cover object-center'
                        onLoadedData={handleVideoLoad}
                    />
                    <video
                        ref={backgroundVideoRef}
                        src={getVideoSrc(currentIndex === totalVideos - 1 ? 3 : currentIndex)}
                        // autoPlay
                        loop
                        muted
                        id="background-video"
                ...
                <h1 className='special-font hero-heading absolute bottom-5 right-5 z-50 text-blue-75'>G<b>a</b>ming</h1>
